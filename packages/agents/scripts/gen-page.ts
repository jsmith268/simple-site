...
app/layout.tsx:
- html/body, import './globals.css', and a Google Fonts <link> for Fraunces (display, with opsz+ital axes), Inter Tight (body), JetBrains Mono (kicker). Set body font-family via inline style or className. Include metadata export (title/description) is OPTIONAL — keep it simple and buildable.
